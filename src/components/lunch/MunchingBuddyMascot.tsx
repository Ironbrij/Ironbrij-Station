      ...
      {isOverdue ? (
        ...
        <div className="relative flex flex-col items-center">
          ...
          >
            ...
            <rect x="46" y="22" width="18" height="20" rx="3" fill="#FDBA74" stroke="#EA580C" strokeWidth="1.5" />
            ...
            <path d="M20 25 Q 24 29 28 25" stroke="#92400E" strokeWidth="2" strokeLinecap="round" fill="none" />
            <path d="M32 25 Q 36 29 40 25" stroke="#92400E" strokeWidth="2" strokeLinecap="round" fill="none" />
            {/* Smile */}
            <path d="M28 32 Q 30 35 32 32" stroke="#92400E" strokeWidth="1.5" strokeLinecap="round" fill="none" />
            {/* Rosy Cheeks */}
        ...
        <div className="relative flex flex-col items-center">
          ...
          >
            ...
            {/* Happy Eyes (^_^) */}
            <path d="M27 22 Q 31 18 35 22" stroke="#92400E" strokeWidth="2" strokeLinecap="round" fill="none" />
            <path d="M41 22 Q 45 18 49 22" stroke="#92400E" strokeWidth="2" strokeLinecap="round" fill="none" />
            ...
            {/* Food / Noodle Bowl */}
            <path d="M24 34 C 24 48 52 48 52 34 Z" fill="#F97316" stroke="#C2410C" strokeWidth="2" />
            <ellipse cx="38" cy="34" rx="14" ry="3.5" fill="#FDE047" stroke="#C2410C" strokeWidth="1.5" />

            {/* Chopsticks */}
            <line x1="42" y1="24" x2="58" y2="16" stroke="#78350F" strokeWidth="1.75" strokeLinecap="round" />
            <line x1="40" y1="26" x2="56" y2="18" stroke="#78350F" strokeWidth="1.75" strokeLinecap="round" />
          </svg>
        </div>
      )}
    </div>
